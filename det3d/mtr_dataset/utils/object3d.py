...
class Object3d(object):
    def __init__(self, label):
        ...
        line = ' '.join([str(attribute) for attribute in label])
        self.src = line
        # exclusive for the mtr dataset based on the 3dmot data format
    ...
    def get_obj_level(self):
        # currently there is not object level
        return 1
    ...
    def generate_corners3d(self):
        ...
        :return corners_3d: (8, 3) corners of box3d in lidar coordinate system
