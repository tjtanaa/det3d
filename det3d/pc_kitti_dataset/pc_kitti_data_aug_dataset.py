...
class PCKittiAugmentedDataset(KittiDatasetBase):
    """
        This is a class that augment the point cloud data and labels.
        This should be the interface that is general so that it will
        be processed again.
        E.g. 
        pointpillar: generate point pillars and targets
        SASSD: generate BEV, and targets.
        VoxelNet: Generate Voxels, and targets
    ...
    def get_sample(self, index):
        ...
        objs_to_cls_type_list = kitti_utils.objs_to_cls_type(gt_obj_list)
        ...
        # sample_info['pts_input'] = pts_input # [x y z i]
    ...
    def apply_gt_aug_to_one_scene(self, sample_id, pts_rect, pts_intensity, all_gt_boxes3d):
        ...
        while try_times > 0:
            ...
            new_gt_obj = self.filtrate_objects([new_gt_obj])

            if (len(new_gt_obj) == 0):
                continue
            
            new_gt_obj = new_gt_obj[0]
